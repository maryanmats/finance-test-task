...
import { companyTickerToTableState, tickersToTableState } from '../../helpers/helpers';
...
import {
  addWatchingTickersAction, 
  delWatchingTickersAction, 
  getTickersAction
} from '../../store/thunks/tickersThunk';
...
export const Tickers: React.FC = () => {
  ...
  return error ? (
    ...
    <Table 
      columns={columns} 
      dataSource={tickersToTableState(currentTickers)} 
      pagination={false} 
    />
  );
};